...
set bmargin 8
set ylabel "Total time (Seconds)" font "Arial,55 italic bold" offset -4.5,0
set lmargin 14
...
#set xtics nomirror
set xtics font "Arial,60 italic bold" offset 0,-0.5
...
plot 'igb-small_batch_20.txt' using 2:xtic(1) title 'DGL' lt rgb "dark-magenta", \
     '' using 3 title 'CentGNN' lt rgb "light-blue"
